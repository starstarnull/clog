...
static struct test* test_manual_level_none();


// Main test function.

struct unit* unit_config_14() {
    ...
    unit->next = NULL;
    assert(unit);
    UNIT_HEADER("Testing Config 14 Options");

    ADD_TEST(unit, test_manual_level_none());
